...
/* 定义读写SCL和SDA的宏，已增加代码的可移植性和可阅读性 */
	...
	#define I2C_SDA_READ()  GPIO_ReadInputDataBit(GPIO_PORT_SOFT_I2C, SOFT_I2C_SDA_PIN)	/* 读SDA口线状态 */
	...
	#define I2C_SDA_READ()  ((GPIO_PORT_SOFT_I2C->IDR & SOFT_I2C_SDA_PIN) != 0)	/* 读SDA口线状态 */
#endif
...
//    /* 1. 开启 AFIO 时钟（重映射必须开启这个） */
//    RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOB | RCC_APB2Periph_AFIO, ENABLE); 

//    /* 2. 禁用 JTAG 功能，释放 PB3, PB4, PA15 等引脚，保留 SWD 调试 */
//    GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable, ENABLE);

//    /* 3. 后面的初始化保持不变 */
//    GPIO_InitStructure.GPIO_Pin = SOFT_I2C_SCL_PIN | SOFT_I2C_SDA_PIN;
//    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
//    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_OD; // 必须是开漏
//    GPIO_Init(GPIOB, &GPIO_InitStructure);
//    
//    GPIO_SetBits(GPIOB, SOFT_I2C_SCL_PIN | SOFT_I2C_SDA_PIN);
}
